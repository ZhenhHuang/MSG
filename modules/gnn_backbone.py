...
def choose_backbone(backbone, n_layers, in_features, hidden_features, out_features, n_heads, drop_edge, drop_node):
    if backbone == 'gcn':
        return GCN(n_layers, in_features, hidden_features, out_features, drop_edge, drop_node)
    elif backbone == 'gat':
        return GAT(n_layers, in_features, hidden_features, out_features, n_heads, drop_edge, drop_node)
    elif backbone == 'sage':
        return GraphSAGE(n_layers, in_features, hidden_features, out_features, drop_edge, drop_node)
    else:
