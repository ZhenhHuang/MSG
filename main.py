...
# Base Params
parser.add_argument('--manifold', type=str, default='lorentz', choices=['euclidean', 'lorentz', 'sphere'])
parser.add_argument('--neuron', type=str, default='IF', choices=['IF', 'LIF'], help="Which neuron to use")
parser.add_argument('--T', type=int, default=70, help="latency of neuron")
...
parser.add_argument('--epochs_cls', type=int, default=10)
