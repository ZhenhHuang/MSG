...
from models import SpikeClassifier, SpikeLinkPredictor
...
class Exp:
    ...
    def train(self):
        ...
        for exp_iter in range(self.configs.exp_iters):
            ...
            # TODO
            model = SpikeClassifier().to(device) if self.configs.downstream_task == 'NC' else SpikeLinkPredictor
    ...
    def cal_cls_loss(self, model, data):
    ...
    def train_cls(self, model_cls, data, logger):
